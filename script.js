...
$('.SolarInverter').on('click', function (e) {
  
  $('.shop-card').hide(300);
  $('*[data-cat="Solar Inverter"]').show(300);
  
});

$('.OnGrid').on('click', function (e) {
  
  $('.shop-card').hide(300);
  $('*[data-cat="On Grid Inverter"]').show(300);
  
});

$('.OffGrid').on('click', function (e) {
  
  $('.shop-card').hide(300);
  $('*[data-cat="Off Grid Inverter"]').show(300);
